...
INSERT INTO cardapios (id, restaurante_id, descricao_cardapio) VALUES(3, 3, 'Cardapio Portugues');

INSERT INTO usuarios (id, tipo_usuario_id, login, email, nome, senha_hash, data_alteracao) VALUES (4, 1, 'teste_login4', 'teste4@teste.com.br', 'nome teste4', 'senhaTeste123', '2025-01-01 00:00:00');--
INSERT INTO restaurantes (id, tipos_cozinha_id, usuario_id, nome) VALUES(4, 1, 4, 'Restaurante Teste4');
INSERT INTO cardapios (id, restaurante_id, descricao_cardapio) VALUES(4, 4, 'Cardapio Japones');