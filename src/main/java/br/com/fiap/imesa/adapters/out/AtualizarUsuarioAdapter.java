...
@Component
public class AtualizarUsuarioAdapter implements AtualizarUsuarioOutport {

    private final UsuarioRepository usuarioRepository;
    private final UsuarioEntityMapper usuarioEntityMapper;

    public AtualizarUsuarioAdapter(UsuarioRepository usuarioRepository,
    ...
    public UsuarioDomain atualizar(UsuarioDomain usuarioDomain){
        ...
        return usuarioEntityMapper.toUsuarioDomain(entity);
    }
}
